...
TEST_CASES = ${_FIZZBUZZ_TESTS} ${_ROMAN_TESTS} ${_ALPHABET_CIPHER_TESTS} ${_SORT_TESTS} ${_SORT_TESTS} ${_KATA_TESTS}
TEST_FILES = ${_FIZZBUZZ_FILES} ${_ROMAN_FILES} ${_ALPHABET_CIPHER_FILES} ${_SORT_FILES} ${_SORT_FILES} ${_KATA_FILES}
